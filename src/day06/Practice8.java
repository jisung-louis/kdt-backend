...
public class Practice8 {
    public static void main(String[] args){
        ...
        boolean isEven = checker.isEven(4);
        ...
        System.out.println(pl.calculateFee(65));
        System.out.println(pl.calculateFee(140));
...
class ParkingLot{
    int calculateFee(int parkedMinute){
        int fee = 1000;
        if(parkedMinute > 30){
            fee += (parkedMinute - 30) / 10 * 500;
        }
