...
public class Practice5 {
    public static void main(String[] args){
        ...
        System.out.printf("%d까지 더했을 때 합계가 %d로 100을 넘습니다.",idx,sum6);
        ...
        */
        ...
        for(;;count++){
            ...
            if(scan.next().equals("end")) break;
        }
        System.out.printf("프로그램을 종료 합니다.[총 %d회 입력]\n",count - 1);
        ...
        int july3 = 5183400;
        int july4 = 11738700;
        int[] july = {july1/10000, july2/10000, july3/10000, july4/10000};
        System.out.println("------- 7월 매출액 -------");
        for(int i = 0; i < 4; i++){
            System.out.printf("%d주차 : ", i+1);
            for(int j = 0; j < july[i]/100; j++){
                System.out.print("■");
            }
            System.out.println(july[i] + "만원");
        }
